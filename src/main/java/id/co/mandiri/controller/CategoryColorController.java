...
public class CategoryColorController {
    ...
    @GetMapping("/list")
    public ResponseEntity<List<CategoryColor>> list() {
    ...
    @PostMapping("/")
    public ResponseEntity<CategoryColor> save(@Valid @RequestBody CategoryColorDTO.CategoriColorRequestNewDTO params) {
